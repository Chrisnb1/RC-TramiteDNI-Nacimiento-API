...
using RC.MS_NacimientoDefuncion.AccessData.Commands;
...
namespace RC.MS_TramiteDNI.API
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddTransient<IRecienNacidoQuery, RecienNacidoQuery>();

            //Services
            services.AddTransient<IRecienNacidosServices, RecienNacidosServices>();
